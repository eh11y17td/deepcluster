...
class DataLoadDf(Dataset):
    ...
    def __getitem__(self, index):
        ...
        """
        # ex) dataset[0][10]のように，インデックスで指定されたときにも呼ばれる
...
class MultiStreamBatchSampler(Sampler):
    ...
    def __iter__(self):
        ...
        # print("iterators:{}".format(len(iterators)))
        # print(next(zip(*iterators)))
        # print(next(sum(subbatch_ind, ()) for subbatch_ind in zip(*iterators)))
        # exit()
